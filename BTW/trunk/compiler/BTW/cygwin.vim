"=============================================================================
" File:		compiler/BTW/cygwin.vim                                           {{{1
...
"------------------------------------------------------------------------
" Description:	Cygwin Filter for Build-Tools-Wrapper -- a Vim plugin.
"
...
"	cygwin.
"   v0.2: Minor changes
"   	%s/loaded_cygwin_vim//g:loaded_BTW_cygwin_vim/
"
...
if exists("g:loaded_BTW_cygwin_vim") 
      \ && !exists('g:force_reload_BTW_cygwin_vim')
  finish 
endif
let g:loaded_BTW_cygwin_vim = 1
let s:cpo_save=&cpo
set cpo&vim
" Avoid global reinclusion }}}1
"------------------------------------------------------------------------
